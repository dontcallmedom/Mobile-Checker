...
exports.format = function (markup, type, category, cb) {
    jsdom.env({html: template, done: function(errors, window) {
        ...
        if (category === "tip") {
            ...
            content.setAttribute("class", "collapse in");
        }
        ...
        if (collapsable) {
            ...
            toggle.setAttribute("aria-controls", "#" + collapsable.id);
