...
exports.check = function(checker, browser) {
    function checkUrls(urls, baseUrl, done) {
        ...
        return browser.webdriver.promise.all(promises).then(done);
    }


    browser.do(function manifest(driver ,done) {
